...
#define LDR_UNLOCK_LOADER_LOCK_FLAG_RAISE_ON_ERRORS 0x00000001
	...
	NTSYSAPI PIMAGE_BASE_RELOCATION
...
#define WORKER_FACTORY_ALL_ACCESS ( \
	...
	typedef enum _SYSTEM_INFORMATION_CLASS
	{
		...
		SystemLostDelayedWriteInformation, // q: ULONG SystemBigPoolInformation, // q: SYSTEM_BIGPOOL_INFORMATION
...
#define GDI_BATCH_BUFFER_SIZE 310
	...
	typedef enum _PROCESSINFOCLASS
	{
		...
		ProcessRaisePriority, // s: ULONG ProcessDebugPort, // q: HANDLE ProcessExceptionPort, // s: HANDLE ProcessAccessToken, // s: PROCESS_ACCESS_TOKEN
		ProcessLdtInformation, // qs: PROCESS_LDT_INFORMATION // 10
		ProcessLdtSize, // s: PROCESS_LDT_SIZE
		ProcessDefaultHardErrorMode, // qs: ULONG ProcessIoPortHandlers, // (kernel-mode only)
		ProcessPooledUsageAndLimits, // q: POOLED_USAGE_AND_LIMITS
		ProcessWorkingSetWatch, // q: PROCESS_WS_WATCH_INFORMATION[]; s: VOID ProcessUserModeIOPL,
		ProcessEnableAlignmentFaultFixup, // s: BOOLEAN ProcessPriorityClass, // qs: PROCESS_PRIORITY_CLASS
		ProcessWx86Information,
		ProcessHandleCount, // q: ULONG, PROCESS_HANDLE_INFORMATION // 20
		ProcessAffinityMask, // s: KAFFINITY
		ProcessPriorityBoost, // qs: ULONG ProcessDeviceMap, // qs: PROCESS_DEVICEMAP_INFORMATION, PROCESS_DEVICEMAP_INFORMATION_EX
		ProcessSessionInformation, // q: PROCESS_SESSION_INFORMATION
		ProcessForegroundInformation, // s: PROCESS_FOREGROUND_BACKGROUND
		ProcessWow64Information, // q: ULONG_PTR
		ProcessImageFileName, // q: UNICODE_STRING
		ProcessLUIDDeviceMapsEnabled, // q: ULONG ProcessBreakOnTermination, // qs: ULONG ProcessDebugObjectHandle, // q: HANDLE // 30
		ProcessDebugFlags, // qs: ULONG ProcessHandleTracing, // q: PROCESS_HANDLE_TRACING_QUERY; s: size 0 disables, otherwise enables
		ProcessIoPriority, // qs: IO_PRIORITY_HINT
		ProcessExecuteFlags, // qs: ULONG ProcessResourceManagement,
		ProcessCookie, // q: ULONG ProcessImageInformation, // q: SECTION_IMAGE_INFORMATION
		ProcessCycleTime, // q: PROCESS_CYCLE_TIME_INFORMATION // since VISTA
		ProcessPagePriority, // q: ULONG ProcessInstrumentationCallback, // 40
		...
		ProcessTokenVirtualizationEnabled, // s: ULONG ProcessConsoleHostProcess, // q: ULONG_PTR
	...
	typedef enum _THREADINFOCLASS
	{
		...
		ThreadImpersonationToken, // s: HANDLE ThreadDescriptorTableEntry, // q: DESCRIPTOR_TABLE_ENTRY (or WOW64_DESCRIPTOR_TABLE_ENTRY)
		ThreadEnableAlignmentFaultFixup, // s: BOOLEAN ThreadEventPair,
		ThreadQuerySetWin32StartAddress, // q: PVOID ThreadZeroTlsCell, // 10
		ThreadPerformanceCount, // q: LARGE_INTEGER
		ThreadAmILastThread, // q: ULONG ThreadIdealProcessor, // s: ULONG ThreadPriorityBoost, // qs: ULONG ThreadSetTlsArrayAddress,
		ThreadIsIoPending, // q: ULONG ThreadHideFromDebugger, // s: VOID ThreadBreakOnTermination, // qs: ULONG ThreadSwitchLegacyState,
		ThreadIsTerminated, // q: ULONG // 20
		ThreadLastSystemCall, // q: THREAD_LAST_SYSCALL_INFORMATION
		ThreadIoPriority, // qs: IO_PRIORITY_HINT
		ThreadCycleTime, // q: THREAD_CYCLE_TIME_INFORMATION
		ThreadPagePriority, // q: ULONG ThreadActualBasePriority,
...
#define PS_ATTRIBUTE_UNKNOWN 0x00040000
	...
	{
		PsAttributeParentProcess, // in HANDLE PsAttributeDebugPort, // in HANDLE PsAttributeToken, // in HANDLE PsAttributeClientId, // out PCLIENT_ID
		PsAttributeTebAddress, // out PTEB *
		PsAttributeImageName, // in PWSTR PsAttributeImageInfo, // out PSECTION_IMAGE_INFORMATION
		PsAttributeMemoryReserve, // in PPS_MEMORY_RESERVE
		PsAttributePriorityClass, // in UCHAR
		PsAttributeErrorMode, // in ULONG PsAttributeStdHandleInfo, // 10, in PPS_STD_HANDLE_INFO
		PsAttributeHandleList, // in PHANDLE PsAttributeGroupAffinity, // in PGROUP_AFFINITY
...
#define ALPC_VIEWFLG_NOT_SECURE 0x40000
	...
	typedef enum _ALPC_PORT_INFORMATION_CLASS
	{
		...
		AlpcUnregisterCompletionListInformation, // s: VOID AlpcAdjustCompletionListConcurrencyCountInformation, // s: in ULONG AlpcRegisterCallbackInformation, // kernel-mode only
		AlpcCompletionListRundownInformation, // s: VOID AlpcWaitForPortReferences
...
#define ALPC_CANCELFLGP_FLUSH 0x10000 // dbg
	...
	NTSYSAPI PPORT_MESSAGE
		NTAPI AlpcGetMessageFromCompletionList(
			_In_ PVOID CompletionList,
	...
	NTSYSAPI PALPC_MESSAGE_ATTRIBUTES
		NTAPI AlpcGetCompletionListMessageAttributes(
			_In_ PVOID CompletionList,
			_In_ PPORT_MESSAGE Message
		);
...
#define PF_REPURPOSED_BY_PREFETCH_INFO_VERSION 1
	...
	typedef enum _SUPERFETCH_INFORMATION_CLASS
	{
		...
		SuperfetchSequenceNumberQuery, // q: ULONG SuperfetchScenarioPhase, // 10
...
#define _NTRTL_H
	...
	_Check_return_ NTSYSAPI PVOID NTAPI RtlLookupElementGenericTableAvl(
		_In_ PRTL_AVL_TABLE Table,
		_In_ PVOID Buffer
	);
...
#define RtlInsertAsRightChild(ParentLinks, ChildLinks) \
	...
	_Check_return_ NTSYSAPI PRTL_SPLAY_LINKS
		NTAPI RtlSubtreeSuccessor(
			_In_ PRTL_SPLAY_LINKS Links
		);

	_Check_return_ NTSYSAPI PRTL_SPLAY_LINKS
		NTAPI RtlSubtreePredecessor(
			_In_ PRTL_SPLAY_LINKS Links
		);

	_Check_return_ NTSYSAPI PRTL_SPLAY_LINKS
		NTAPI RtlRealSuccessor(
			_In_ PRTL_SPLAY_LINKS Links
		);

	_Check_return_ NTSYSAPI PRTL_SPLAY_LINKS
		NTAPI RtlRealPredecessor(
			_In_ PRTL_SPLAY_LINKS Links
		);
...
#define RTL_DUPLICATE_UNICODE_STRING_ALLOCATE_NULL_STRING (0x00000002)
	...
	_Must_inspect_result_
		NTSYSAPI LONG
		NTAPI RtlCompareUnicodeStrings(
...
#define RTL_FIND_CHAR_IN_UNICODE_STRING_CASE_INSENSITIVE 0x00000004
	...
	NTSYSAPI WCHAR
		NTAPI RtlAnsiCharToUnicodeChar(
	...
	NTSYSAPI PUNICODE_PREFIX_TABLE_ENTRY
		NTAPI RtlFindUnicodePrefix(
			_In_ PUNICODE_PREFIX_TABLE PrefixTable,
...
#define RtlExitUserThread RtlExitUserThread_R
	...
	// rev
	NTSYSAPI PLIST_ENTRY
		NTAPI RtlGetFunctionTableListHead(
			VOID);
...
#define RTL_IMAGE_NT_HEADER_EX_FLAG_NO_RANGE_CHECK 0x00000001
	...
	NTSYSAPI PIMAGE_SECTION_HEADER
		NTAPI RtlSectionTableFromVirtualAddress(
			_In_ PIMAGE_NT_HEADERS NtHeaders,
			_In_ PVOID BaseOfImage,
			_In_ ULONG VirtualAddress
		);
...
#define RTL_CREATE_ENVIRONMENT_EMPTY 0x4 // create empty environment block
	...
	NTSYSAPI RTL_PATH_TYPE
		NTAPI RtlDetermineDosPathNameType_U(
...
#define RtlIpv6StringToAddressEx RtlIpv6StringToAddressExW
	...
	_Check_return_ NTSYSAPI BOOLEAN NTAPI RtlTestBit(
	...
	_Success_(return != -1)
		_Check_return_ NTSYSAPI ULONG NTAPI RtlFindClearBits(
			_In_ PRTL_BITMAP BitMapHeader,
	...
	_Success_(return != -1)
		_Check_return_ NTSYSAPI ULONG NTAPI RtlFindSetBits(
			_In_ PRTL_BITMAP BitMapHeader,
			_In_ ULONG NumberToFind,
			_In_ ULONG HintIndex
		);
...
#define RTL_HANDLE_ALLOCATED (USHORT)0x0001
	...
	NTSYSAPI PRTL_HANDLE_TABLE_ENTRY
		NTAPI RtlAllocateHandle(
...
#define RTL_ATOM_PINNED 0x01
	...
	NTSYSAPI PSID_IDENTIFIER_AUTHORITY
		NTAPI RtlIdentifierAuthoritySid(
			_In_ PSID Sid
		);
...
#define RTL_UNLOAD_EVENT_TRACE_NUMBER 64
	...
	NTSYSAPI PRTL_UNLOAD_EVENT_TRACE
		NTAPI RtlGetUnloadEventTrace(
			VOID);
...
#define _NTTP_H
	...
	// private
	_Check_return_ NTSYSAPI NTSTATUS NTAPI TpAllocPool(
	...
	// private
	_Check_return_ NTSYSAPI NTSTATUS NTAPI TpAllocCleanupGroup(
...
#define SAM_SID_COMPATIBILITY_STRICT 2
	...
	_Check_return_ NTSTATUS NTAPI SamGetCompatibilityMode(
		_In_ SAM_HANDLE ObjectHandle,
		_Out_ ULONG *Mode
	);
...
#define SAM_VALIDATE_PASSWORD_HISTORY 0x00000020
	...
	_Check_return_ NTSTATUS NTAPI SamValidatePassword(
		_In_opt_ PUNICODE_STRING ServerName,
