# ![Logo](Logo.png) NSudo - 一个强大的系统管理工具
...
[![FOSSA 状态](https://app.fossa.io/api/projects/git%2Bgithub.com%2FM2Team%2FNSudo.svg?type=shield)](https://app.fossa.io/projects/git%2Bgithub.com%2FM2Team%2FNSudo?ref=badge_shield)
...
- Git 仓库列表
  - [GitHub（主仓库）](https://github.com/M2Team/NSudo)
  - [Gitee（镜像仓库）](https://gitee.com/M2-Team/NSudo)
- 社区
  - [GitHub](https://github.com/M2Team/NSudo/issues)
  - [MDL](https://forums.mydigitallife.net/threads/59268/)
  - [吾爱破解](https://www.52pojie.cn/thread-847059-1-1.html)
- 联系方式
...
你的 Intel 或 AMD 设备上使用64位 NSudo，你首先需要打开的是 x64 目录，然后双击
NSudoG.exe。
